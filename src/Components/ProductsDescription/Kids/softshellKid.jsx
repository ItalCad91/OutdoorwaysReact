...
function softshellKid() {
  ...
  const localStorageKey = 'softKidReviews';
  ...
  const handlePurchase = () => {
    ...
    window.open("https://square.link/u/8uomZuN2", "_blank");
  };
  ...
  return (
    <Container>
      <ProductName>SoftShell Jacket</ProductName>
      <ProductImage src="../images/softshellKid.png" alt="Insulated Camping Water Bottle" />
      <Description>
      A stretchy and versatile jacket that provides protection from wind, light rain, and moderate temperatures, suitable for a wide range of outdoor activities.
      </Description>
      <Price>$29.99</Price>
      <div>
