...
function hatKid() {
  ...
  const localStorageKey = 'hatKidReviews';
  ...
  const handlePurchase = () => {
    ...
    window.open("https://square.link/u/xeqOdmx2", "_blank");
  };
  ...
  return (
    <Container>
      <ProductName>Kids Hiking Hat</ProductName>
      <ProductImage src="../images/hatKid.png" alt="Insulated Camping Water Bottle" />
      <Description>
