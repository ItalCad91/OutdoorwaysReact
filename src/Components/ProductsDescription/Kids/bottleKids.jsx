...
function BottleKids() {
  ...
  const localStorageKey = 'bottleKidsReviews';
  ...
  const handlePurchase = () => {
    ...
    window.open("https://square.link/u/30xazO9V", "_blank");
  };
  ...
  return (
    <Container>
      ...
      <ProductImage src="../images/bottleKids.png" alt="Insulated Camping Water Bottle" />
      <Description>
