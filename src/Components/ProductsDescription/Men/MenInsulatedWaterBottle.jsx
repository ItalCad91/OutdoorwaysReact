...
function MenWaterBottle() {
  ...
  const localStorageKey = 'MenWaterBottleReviews';
  ...
  const handlePurchase = () => {
    ...
    window.open("https://square.link/u/H3HM2qU6", "_blank");
  };
  ...
  return (
    <Container>
      <ProductName>Insulated Camping Water Bottle</ProductName>
      <ProductImage src="../images/Bottle.png" alt="men boots" />
      <Description>
      A vacuum-sealed bottle that keeps drinks cold or hot for hours, made of high-quality materials that are resistant to leaks and spills.
      </Description>
      <Price>$14.99</Price>
      <div>
