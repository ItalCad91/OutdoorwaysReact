...
function MenPole() {
  ...
  const localStorageKey = 'MenPoleReviews';
  ...
  const handlePurchase = () => {
    ...
    window.open("ttps://square.link/u/HuuzjD0Z", "_blank");
  };
  ...
  return (
    <Container>
      ...
      <ProductImage src="../images/hatMen.png" alt="men boots" />
      <Description>
