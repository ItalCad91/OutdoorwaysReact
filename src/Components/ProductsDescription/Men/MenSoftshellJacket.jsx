...
function SoftMen() {
  ...
  const localStorageKey = 'SoftMenReviews';
  ...
  const handlePurchase = () => {
    ...
    window.open("https://square.link/u/PjDDj69L", "_blank");
  };
  ...
  return (
    <Container>
      ...
      <ProductImage src="../images/softshellMen.png" alt="men boots" />
      <Description>
