...
function WomenJacket() {
  ...
  const localStorageKey = 'WomenJacketReviews';
  ...
  const handlePurchase = () => {
    ...
    window.open("https://square.link/u/FFaQm1sQ", "_blank");
  };
  ...
  return (
    <Container>
      <ProductName>Waterproof Jacket</ProductName>
      <ProductImage src="../images/WomenRaincoat.png" alt="men boots" />
      <Description>
      A vacuum-sealed bottle that keeps drinks cold or hot for hours, made of high-quality materials tA lightweight, breathable jacket that protects against wet weather conditions while ensuring optimal ventilation and mobility for outdoor activities.
      </Description>
      <Price>$59.99</Price>
      <div>
