...
function WomenBoots() {
  ...
  const localStorageKey = 'WomenBootsReviews';
  ...
  const handlePurchase = () => {
    ...
    window.open("https://square.link/u/4u95yc27", "_blank");
  };
  ...
  return (
    <Container>
      <ProductName>Hiking Boots</ProductName>
      <ProductImage src="../images/WomenBoots.png" alt="men boots" />
      <Description>
