...
function WomenSoft() {
  ...
  const localStorageKey = 'WomenSoftReviews';
  ...
  const handlePurchase = () => {
    ...
    window.open("https://square.link/u/Hwr1ZZjB", "_blank");
  };
  ...
  return (
    <Container>
      ...
      <ProductImage src="../images/Softshell.png" alt="men boots" />
      <Description>
