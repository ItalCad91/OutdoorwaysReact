...
function WomenPole() {
  ...
  const localStorageKey = 'WomenPoleReviews';
  ...
  const handlePurchase = () => {
    ...
    window.open("https://square.link/u/HuuzjD0Z", "_blank");
  };
  ...
  return (
    <Container>
      ...
      <ProductImage src="../images/Pole.png" alt="men boots" />
      <Description>
